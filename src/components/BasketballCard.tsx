...
export const BasketballCard: React.FC<BasketballCardProps> = ({ game, index = 0 }) => {
  ...
  const getStatusDisplay = () => {
    if (isLive) {
      ...
      return {
        text: gameTime.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
        bgColor: 'bg-blue-500',
        textColor: 'text-white',
        showPulse: false
      };
      ...
      <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 border-b border-gray-200 dark:border-gray-600">
        <div className="flex items-center space-x-2">
          <div className="w-5 h-5 bg-orange-400 rounded-full flex items-center justify-center">
            <svg className="w-3 h-3 text-orange-800" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center space-x-3 flex-1">
            <div className="w-10 h-10 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center overflow-hidden">
              <img 
                ...
                onError={(e) => {
                  e.currentTarget.src = 'data:image/svg+xml;base64,';
                }}
              />
            </div>
          ...
          <div className="flex items-center space-x-4 mx-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900 dark:text-white">
                {game.scores.home.total !== null ? game.scores.home.total : '-'}
              </div>
            </div>
            <div className="text-gray-400 font-medium">-</div>
            <div className="text-center">
              <div className="text-2xl font-bold text-gray-900 dark:text-white">
                {game.scores.away.total !== null ? game.scores.away.total : '-'}
              </div>
            </div>
          </div>
