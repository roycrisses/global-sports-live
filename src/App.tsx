            ...
            <div className="max-w-7xl mx-auto px-4">
              <div className="flex items-center justify-between h-12">
                ...
                <div className="flex items-center space-x-6 text-sm">
                  <button type="button" className="hover:underline bg-transparent border-none p-0 cursor-pointer">Home</button>
                  <button type="button" className="hover:underline bg-transparent border-none p-0 cursor-pointer">News</button>
                  <button type="button" className="hover:underline bg-transparent border-none p-0 cursor-pointer">Sport</button>
                  <button type="button" className="hover:underline bg-transparent border-none p-0 cursor-pointer">Business</button>
                  <button type="button" className="hover:underline bg-transparent border-none p-0 cursor-pointer">Innovation</button>
                  <button type="button" className="hover:underline bg-transparent border-none p-0 cursor-pointer">Culture</button>
                  <button type="button" className="hover:underline bg-transparent border-none p-0 cursor-pointer">Travel</button>
                  <button type="button" className="hover:underline bg-transparent border-none p-0 cursor-pointer">⋯</button>
                  <div className="flex items-center space-x-2">
